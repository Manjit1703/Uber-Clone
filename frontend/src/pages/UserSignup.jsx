...
const UserSignup = () => {
  ...
  const submitHandler = async(e) => {
    ...
    try {
      ...
      // display error message or feedback to the user here
    }
  ...
  return (
    <div className="p-7 h-screen flex flex-col justify-between">
      <div>
        ...
        >
          <h3 className="text-base font-medium mt-4 mb-2">What's Your Name</h3>
          ...
          <h3 className="text-base font-medium mt-4 mb-2">What's Your Email</h3>
          <input
            required
